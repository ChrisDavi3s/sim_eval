...
class TestFrames(unittest.TestCase):
  ...
  def test_get_mae(self):
      ...
      np.testing.assert_allclose(
          self.frames.get_mae(energy_metric_structure, self.vasp_calc, self.nequip_calc),
          expected_energy_mae
      )
      ...
      np.testing.assert_allclose(
          self.frames.get_mae(stress_metric_structure, self.vasp_calc, self.nequip_calc),
          expected_stress_mae
      )
  ...
  def test_get_rmse(self):
      ...
      np.testing.assert_allclose(
          self.frames.get_rmse(energy_metric_structure, self.vasp_calc, self.nequip_calc),
      ...
      np.testing.assert_allclose(
          self.frames.get_rmse(stress_metric_structure, self.vasp_calc, self.nequip_calc),
  ...
  def test_get_correlation(self):
      ...
      np.testing.assert_allclose(
          self.frames.get_correlation(energy_metric_structure, self.vasp_calc, self.nequip_calc),
      ...
      np.testing.assert_allclose(
          self.frames.get_correlation(stress_metric_structure, self.vasp_calc, self.nequip_calc),
